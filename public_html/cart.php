...
<body>
		...
		<div class="bottom-section">
			...
			<div class="right">
				<div class="grid-total">
					...
					<div class="item-total shipping">Calculated at next step</div>
	...
	<script>
		...
		function updateCartTotals() {
			...
			document.querySelector('.shipping').textContent = shipping === 0 ? 'Calculated at next step' : `$${shipping.toFixed(2)}`;
